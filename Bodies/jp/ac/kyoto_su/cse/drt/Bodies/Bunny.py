...
from jp.ac.kyoto_su.cse.drt.MVC.Model import OpenGLModel
from jp.ac.kyoto_su.cse.drt.MVC.Model import OpenGLView
from jp.ac.kyoto_su.cse.drt.Parts.Triangle import OpenGLTriangle
